    ...
    <View style={styles.commentContainer}>
      <View style={styles.commentHeader}>
        ...
        <View style={styles.colSec}>
          ...
          <Text style={styles.commentTimestamp}>{new Date(item.createdAt).toLocaleDateString()}  {new Date(item.createdAt).toLocaleTimeString('id-ID',{hour:'2-digit',minute:"2-digit"})}</Text>
        </View>
      </View>
    </View>
  );
